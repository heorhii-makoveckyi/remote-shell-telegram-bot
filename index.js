...
const { initLocale, setLocale, getReplyInstruction } = require('./handlers/locales')

initLocale('./locales/', './locales/currentLocale.txt')
...
bot.command('start', getReplyInstruction)
bot.command('help', getReplyInstruction)
bot.command('ru', (ctx) => {
     setLocale('ru')
